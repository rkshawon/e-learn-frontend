  ...
  return (
    <div className="flex h-[55vh] w-full items-center justify-between px-10">
      <Image
        ...
        alt="bg-img"
        className="absolute inset-0 ml-auto w-[920px] h-[680px] rounded-bl-[100px] object-cover object-center"
      />
      <div className="container mx-auto mt-28">
        <div className="grid grid-cols-12 text-center lg:text-left">
          <div className="col-span-full rounded-xl border border-white bg-white/90 py-10 p-8 shadow-lg shadow-black/10 backdrop-blur-sm backdrop-saturate-200 xl:col-span-7">
            <h1 className="text-blue-gray lg:text-5xl leading-relaxed text-3xl lg:max-w-3xl font-semibold">
              Unlock the Power of the Web with Our Expert Courses
            </h1>
            <p className="text-gray-900 mb-10 mt-6">
